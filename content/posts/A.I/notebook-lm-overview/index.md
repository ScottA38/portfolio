...
![Lanscape with cliffs in the foreground, the sea and a traditional large ship sailing across the horizon](./hector-john-periquin-ZfTouherc3M-unsplash.jpg)
...
![A screenshot of the homepage for NotebookLM's website](./notebooklm-splash-screen.png)
...
![A screenshot of the project browser within the NotebookLM App](./notebooklm-project-browser.png)
...
![An example project editor screen within NotebookLM, with resources loaded about the WCAG-2](./notebooklm-project-wcag2.png)
...
![A photograph from inside of a large-scale terrarium project with a grid-like curving roof](./shawn-d5Sf_fKtLGs-unsplash.jpg)
...
![A screenshot of the 'Delightful Vistas' homepage from Mark Bernstein](./mark-bernstein-delightful-vistas.png)
